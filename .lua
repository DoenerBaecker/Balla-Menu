local appID = "296383927034052610"
...
do
    function UIMenuSliderProgressItem.New(Text, Items, Index, Description, SliderColors, BackgroundSliderColors)
        ...
        local Offset =
            ((_UIMenuSliderProgressItem.Background.Width) / (#_UIMenuSliderProgressItem.Items - 1)) *
...
do
    function UIMenuColourPanel.New(Title, Colours)
        local _UIMenuColourPanel = {
            ...
            Text = UIResText.New(
                Title .. " [1 / " .. #Colours .. "]" or "Title" .. " [1 / " .. #Colours .. "]",
                0,
                0,
                0.35,
                255,
    ...
    function UIMenuColourPanel:Position(Y)
        if tonumber(Y) then
            local ParentOffsetX, ParentOffsetWidth =
                self.ParentItem:Offset().X,
                self.ParentItem:SetParentMenu().WidthOffset
    ...
    function UIMenuGridPanel:CirclePosition(X, Y)
        if tonumber(X) and tonumber(Y) then
            ...
            return math.round(
                ...
                2
            ), math.round((self.Circle.Y - (self.Grid.Y + 20) + (self.Circle.Height / 2)) / (self.Grid.Height - 40), 2)
        end
    end
                        ...
                        function()
                            ...
                            while IsDisabledControlPressed(0, 24) and
                                ...
                                local CursorX, CursorY =
                                    ConvertToPixel(
                                    GetControlNormal(0, 239) - DrawOffset.X,
                                    GetControlNormal(0, 240) - DrawOffset.Y
                                )
    ...
    function UIMenuHorizontalOneLineGridPanel:CirclePosition(X, Y)
        if tonumber(X) and tonumber(Y) then
            ...
            return math.round(
                (self.Circle.X - (self.Grid.X + 20) + (self.Circle.Width / 2)) / (self.Grid.Width - 40),
                2
            ), math.round((self.Circle.Y - (self.Grid.Y + 10) + (self.Circle.Height / 2)) / (self.Grid.Height - 40), 2)
        end
    end
                            ...
                            while IsDisabledControlPressed(0, 24) and
                                ...
                                local moveCursorX =
                                    ...
                                    ((CursorX < (self.Grid.X + 20 - (self.Circle.Width / 2))) and
                                        ...
                                        CursorX)
                                local moveCursorY =
                                    (CursorY > (self.Grid.Y + 10 + self.Grid.Height - 120)) and
                                    (self.Grid.Y + 10 + self.Grid.Height - 120) or
                                    ((CursorY < (self.Grid.Y + 100 - (self.Circle.Height / 2))) and
...
do
    ...
    function UIMenuPercentagePanel:Functions()
        ...
        if
            IsMouseInBounds(
                self.BackgroundBar.X,
                self.BackgroundBar.Y - 4,
                self.BackgroundBar.Width,
                    ...
                    Citizen.CreateThread(
                        function()
                            while IsDisabledControlPressed(0, 24) and
                                ...
                                self:UpdateParent(
                                    math.round(
                                        ((Progress >= 0 and Progress <= 413) and Progress or
                                            ((Progress < 0) and 0 or 413)) / self.BackgroundBar.Width,
                                        2
                                    )
                                )
                            end
        ...
        if tonumber(Y) then
            ...
            for i = 1, #self.Items do
                ...
                self.Items[i].BackgroundProgressBar:Position(
                    ParentOffsetX + (ParentOffsetWidth / 2) + 200,
                    Y - 22 + OffsetItemCount
                )
                self.Items[i].ProgressBar:Position(
                    ParentOffsetX + (ParentOffsetWidth / 2) + 200,
                    Y - 22 + OffsetItemCount
                )
                if self.Divider ~= false then
                    for _ = 1, #self.Items[i].Divider, 1 do
                        ...
                        self.Items[i].Divider[_]:Position(
                            ParentOffsetX + (ParentOffsetWidth / 2) + 200 + DividerOffsetWidth,
                            Y - 22 + OffsetItemCount
                        )
                        self.Background:Size(
                            431 + self.ParentItem:SetParentMenu().WidthOffset,
                            47 + OffsetItemCount - 39
                        )
                    end
                end
            end
                    ...
                    Citizen.CreateThread(
                        function()
                            ...
                            while IsDisabledControlPressed(0, 24) and
                                ...
                                CursorX, CursorY = CursorX - (self.Circle.Width / 2), CursorY - (self.Circle.Height / 2)
                                local moveCursorX =
                                    ((CursorX > (self.Grid.X + 10 + self.Grid.Width - 120)) and
                                    (self.Grid.X + 10 + self.Grid.Width - 120) or
                                    ((CursorX < (self.Grid.X + 100 - (self.Circle.Width / 2))) and
...
do
    function UIMenu.New(Title, Subtitle, X, Y, TxtDictionary, TxtName, Heading, R, G, B, A)
        ...
        local _UIMenu = {
            ...
            Banner = nil,
            Title = UIResText.New(Title, 215 + X, 20 + Y, 1.15, 255, 0, 0, 255, 4, 1, 0),
            BetterSize = true,
            Subtitle = {ExtraY = 0},
            WidthOffset = 0,
            Position = {X = X, Y = Y},
        ...
        if Subtitle ~= "" and Subtitle ~= nil then
            ...
            _UIMenu.PageCounter.Text =
                UIResText.New(
                "",
                425 + _UIMenu.Position.X,
                110 + _UIMenu.Position.Y,
                0.35,
                245,
                245,
                245,
        ...
        if _UIMenu.BetterSize == true then
            ...
            if _UIMenu.Subtitle.Rectangle ~= nil then
                ...
                _UIMenu.PageCounter.Text:Position(
                    425 + _UIMenu.Position.X + _UIMenu.WidthOffset,
                    110 + _UIMenu.Position.Y
                )
            end
    ...
    function UIMenu:RecalculateDescriptionPosition()
        ...
        self.Description.Text:Position(self.Position.X + 4, 152 + self.Position.Y + WindowHeight)
    ...
    function UIMenu:AddSpacerItem(Title, Description)
        ...
        if string.IsNullOrEmpty(Description) then
            spacerItem = UIMenuItem.New(output, "")
        else
            spacerItem = UIMenuItem.New(output, Description)
        end
    ...
    function UIMenu:DrawCalculations()
        ...
        self.Extra.Up:Position(
            self.Position.X,
            144 + self:CalculateItemHeight() + self.Position.Y + WindowHeight + offsetExtra
        )
        self.Extra.Down:Position(
            self.Position.X,
            144 + 18 + self:CalculateItemHeight() + self.Position.Y + WindowHeight + offsetExtra
        )
        ...
        if not self.LeftPressed then
            if
                self.Controls.Left.Enabled and
                    (IsDisabledControlJustPressed(0, 174) or IsDisabledControlJustPressed(1, 174) or
                        IsDisabledControlJustPressed(2, 174))
             then
        ...
        if not self.RightPressed then
            if
                self.Controls.Right.Enabled and
                    (IsDisabledControlJustPressed(0, 175) or IsDisabledControlJustPressed(1, 175) or
                        IsDisabledControlJustPressed(2, 175))
             then
                Citizen.CreateThread(
                    function()
                        local type, subtype = self.Items[self:CurrentSelection()]()
    ...
    function UIMenu:GoLeft()
        local type, subtype = self.Items[self:CurrentSelection()]()
        if
            subtype ~= "UIMenuListItem" and subtype ~= "UIMenuSliderItem" and subtype ~= "UIMenuProgressItem" and
                subtype ~= "UIMenuSliderHeritageItem" and
                subtype ~= "UIMenuSliderProgressItem"
         then
            return
        end
                    ...
                    if IsDisabledControlJustPressed(0, 24) then
                        Citizen.CreateThread(
                            function()
                                ...
                                Citizen.Wait(175)
                                while IsDisabledControlPressed(0, 24) and
                                    IsMouseInBounds(_X, _Y, _Width, _Height, self.DrawOffset) do
                                    if Item:Selected() and Item:Enabled() then
                                        if SubType == "UIMenuListItem" then
                                            if
                                                IsMouseInBounds(
                                    ...
                                    elseif not Item:Selected() then
                                        ...
                                        PlaySoundFrontend(
                                            -1,
                                            self.Settings.Audio.Error,
                                            self.Settings.Audio.Library,
                                            true
                                        )
                                        self.OnIndexChange(self, self:CurrentSelection())
                                        self.ReDraw = true
    ...
    function UIMenu:AddEnabledControl(Inputgroup, Control, Controller)
        if tonumber(Inputgroup) and tonumber(Control) then
            table.insert(
                self.Settings.EnabledControls[(Controller and "Controller" or "Keyboard")],
                {Inputgroup, Control}
            )
        end
    end
...
do
    ...
    function MenuPool:AddSubMenu(Menu, Text, Description, BindMenu, KeepPosition, KeepBanner)
        if BindMenu ~= nil then
            BindMenu = ToBool(BindMenu)
        else
            BindMenu = true
        end
        if KeepPosition ~= nil then
            KeepPosition = ToBool(KeepPosition)
        else
            KeepPosition = true
        end
        if KeepBanner ~= nil then
            KeepBanner = ToBool(KeepBanner)
        else
            KeepBanner = true
        end
        if Menu() == "UIMenu" then
...
HankBalla = NativeUI.CreateMenu("~w~Neger Menu", "Version 4.0", X, Y, "commonmenu", "gradient_bgd")

HankBallaPool = NativeUI.CreatePool()
HankBallaPool:Add(HankBalla)
...
-- Player Options
local Enable_InfiniteStamina = true
local Enable_Invisibility = false
local Enable_Invincible = false
local Enable_NoClip = false
local Enable_SuperJump = false
local Enable_NoRagdoll = false
local Enable_FastRun = false
local Enable_ExplosiveFists = false
local Enable_NoFall = false
local Enable_Mouse = false

-- Teleport Options
local TeleportToWayPoint = false
...
local Enable_infiniteammo = false
local Enable_OneShot = false
local Enable_RapidFire = false
local Enable_TriggerBot = false 

-- Vehicle Options
local Enable_waterp = false
local Enable_SpeedBoost = false
local Enable_twostep = false
local Enable_VehicleGodMode = false

-- Triggers
local Enable_Vangelico = false

-- Troll Options
local Enable_Nuke = false
local Enable_BombShooters = false
local Enable_PedVehFly = false
local Enable_NoisyCars = false
local Enable_DisCars = false
local Enable_DisGuns = false
local Enable_WorldFuck = false
...
do
    HoaxChoice = {"Ninef", "Bati", "Gauntlet", "Dubsta", "Granger", "Sanchez", "Bmx", "Bus", "Seashark"}
    --==================================================================================================================================================--
    Boats = {
        "Dinghy",
        "Dinghy2",
...
function CreateWeaponList()
    ...
    for code, name in pairs(WeaponNames) do
        ...
        if (realName ~= "weapon_unarmed") then
            ...
            if _weaponsList == nil then
                table.insert(_weaponsList, validWeapon)
            end

            if not table.Contains(_weaponsList, validWeapon) then
                table.insert(_weaponsList, validWeapon)
            end
        end
    end
    ...
    if not (string.IsNullOrEmpty(inputName)) then
        ...
        if IsWeaponValid(model) then
            ...
            FiveM.Notify(
                "This (" ..
                    tostring(inputName) ..
                        ") is not a valid weapon model name, or the model hash (" ..
                            tostring(model) .. ") could not be found in the game files.",
...
function SpawnWeaponMenu(WeaponSpawnMenu, PlayerPed)
    ...
    spawnWeapon.Activated = function(menu, item, index)
        SpawnCustomWeapon(PlayerPed)
    end
    WeaponSpawnMenu:AddItem(spawnWeapon)

    WeaponSpawnMenu:AddSpacerItem("↓ Weapon Categories ↓")

    local handGunsMenu = (HankBallaPool:AddSubMenu(WeaponSpawnMenu, "Handguns"))
    handGunsMenu.Item:RightLabel("🏀")
    handGunsMenu = handGunsMenu.SubMenu

    local riflesMenu = (HankBallaPool:AddSubMenu(WeaponSpawnMenu, "Assault Rifles"))
    riflesMenu.Item:RightLabel("🏀")
    riflesMenu = riflesMenu.SubMenu

    local shotgunsMenu = (HankBallaPool:AddSubMenu(WeaponSpawnMenu, "Shotguns"))
    shotgunsMenu.Item:RightLabel("🏀")
    shotgunsMenu = shotgunsMenu.SubMenu

    local smgsMenu = (HankBallaPool:AddSubMenu(WeaponSpawnMenu, "Sub-/Light Machine Guns"))
    smgsMenu.Item:RightLabel("🏀")
    smgsMenu = smgsMenu.SubMenu

    local throwablesMenu = (HankBallaPool:AddSubMenu(WeaponSpawnMenu, "Throwables"))
    throwablesMenu.Item:RightLabel("🏀")
    throwablesMenu = throwablesMenu.SubMenu

    local meleeMenu = (HankBallaPool:AddSubMenu(WeaponSpawnMenu, "Melee"))
    meleeMenu.Item:RightLabel("🏀")
    meleeMenu = meleeMenu.SubMenu

    local heavyMenu = (HankBallaPool:AddSubMenu(WeaponSpawnMenu, "Heavy Weapons"))
    heavyMenu.Item:RightLabel("🏀")
    heavyMenu = heavyMenu.SubMenu

    local snipersMenu = (HankBallaPool:AddSubMenu(WeaponSpawnMenu, "Sniper Rifles"))
    ...
    for key, weapon in pairs(weaponList) do
        ...
        if not string.IsNullOrEmpty(weapon.Name) then
            local weaponItem =
                NativeUI.CreateItem(weapon.Name, "Open the options for " .. tostring(weapon.Name) .. "b.")
            weaponItem:SetLeftBadge(BadgeStyle.Gun)

            local weaponMenu =
                (HankBallaPool:AddSubMenu(
                WeaponSpawnMenu,
                "" .. tostring(weapon.Name) .. "b Options",
                weapon.Name,
                "false"
            ))
            ...
            local getOrRemoveWeapon =
                NativeUI.CreateItem("Equip/Remove Weapon", "Add or remove this weapon to/form your inventory.")
            ...
            if (table.Count(weapon.Components) > 0) then
                ...
                for comp, _ in pairs(weapon.Components) do
                    compItem =
                        ...
                        WeaponComponentNames[comp],
                        component,
                        "Click to equip or remove this component."
                    )
...
do
    FiveM.Notify = function(text, type)
        ...
        if type == NotificationType.Info then
            AddTextComponentString("~h~Info~h~b: " .. text)
        elseif type == NotificationType.Error then
            AddTextComponentString("~h~Error~h~b: " .. text)
        elseif type == NotificationType.Alert then
            AddTextComponentString("~h~Alert~h~b: " .. text)
        elseif type == NotificationType.Success then
            AddTextComponentString("~h~Success~h~b: " .. text)
        else
    ...
    FiveM.DirtyVehicle = function(vehicle)
        SetVehicleDirtLevel(vehicle, 15.0)
    end

    FiveM.CleanVehicle = function(vehicle)
        SetVehicleDirtLevel(vehicle, 1.0)
    end

    FiveM.DriftVehicle = function(vehicle)
        SetVehicleReduceGrip(vehicle, 1.0)
        SetVehicleEngineTorqueMultiplier(vehicle, 8.0)
    end

    FiveM.SuperHandling = function(vehicle)
        SetVehicleGravityAmount(vehicle, 15.0)
    end
            ...
            function()
                ...
                if GetResourceState(resource) == "started" then
                    ...
                    if item_subtype == "UIMenuItem" then
                        item:SetRightBadge(BadgeStyle.None)
                    end
                else
                    if item ~= nil then
                        item:Enabled(false)
        ...
        function()
            if GetResourceState("es_extended") == "started" then
                while ESX == nil and ShowMenu do
                    ...
                    FiveM.Notify("¦ Welcome, " .. GetPlayerName(PlayerId()) .. "")
                    Citizen.Wait(0)
                end
            end
        end
            ...
            ESX.TriggerServerCallback(
                ...
                function(players)
                    for i = 1, #players do
                        ...
                        if name == GetPlayerName(playerIdx) then
                            xPlayer = players[i]
                        end
                    end
...
do
    function TeleportToPlayer(playerIdx)
        ...
        entity =
            IsPedInAnyVehicle(GetPlayerPed(playerIdx), false) and GetVehiclePedIsUsing(GetPlayerPed(playerIdx)) or
            GetPlayerPed(playerIdx)
        SetEntityCoords(entity, GetEntityCoords(GetPlayerPed(-1)), 0.0, 0.0, 0.0, false)
    end

    function TeleportToCoordz()
        local x = FiveM.GetKeyboardInput("Enter X Pos", "", 100)
        local y = FiveM.GetKeyboardInput("Enter Y Pos", "", 100)
        local z = FiveM.GetKeyboardInput("Enter Z Pos", "", 100)
        local entity
    ...
    FiveM.TeleportToCoords = function(coordinate)
        ...
        local inVehicle =
            IsPedInAnyVehicle(playerPed, 0) and
            (GetPedInVehicleSeat(GetVehiclePedIsIn(GetPlayerPed(-1), 0), -1) == playerPed)
        ...
        FiveM.Subtitle("Teleported to waypoint!")
    end
    ...
    function doshit(playerVeh)
        ...
        SetVehicleNumberPlateText(playerVeh, "BallaFTW")
    ...
    local function EEntities(initFunc, moveFunc, disposeFunc)
    ...
    function EObjects()
        return EEntities(FindFirstObject, FindNextObject, EndFindObject)
    end

    function EPeds()
        return EEntities(FindFirstPed, FindNextPed, EndFindPed)
    end

    function EVehicles()
        return EEntities(FindFirstVehicle, FindNextVehicle, EndFindVehicle)
    end

    function EPickups()
        return EEntities(FindFirstPickup, FindNextPickup, EndFindPickup)
    end
...
do
    ...
    function DriveToWaypoint(style)
        ...
        if DoesBlipExist(GetFirstBlipInfoId(8)) then
            ...
            FiveM.Notify("No waypoint!", NotificationType.Error)
        end
        if WaypointCoords ~= nil then
            ...
            if GetVehicleModelMaxSpeed ~= nil then
                TaskVehicleDriveToCoordLongrange(
                    ...
                    vehicle,
                    WaypointCoords,
                    GetVehicleModelMaxSpeed(vehicleEntity),
                    style,
                    10
                )
            else
                TaskVehicleDriveToCoordLongrange(
                    ...
                    vehicle,
                    WaypointCoords,
                    Citizen.InvokeNative(0xF417C2502FFFED43, vehicleEntity),
                    style,
                    10
                )
            end
            Citizen.CreateThread(
                function()
                    while DriveToWpTaskActive and
                        GetDistanceBetweenCoords(WaypointCoords, GetEntityCoords(vehicle), false) > 15 do
            ...
            FiveM.Notify("Waypoint missing!", NotificationType.Error)
        end
    end
    ...
    function SpawnVehicleToPlayer(modelName, playerIdx)
        if modelName and IsModelValid(modelName) and IsModelAVehicle(modelName) then
            ...
            local SpawnedVehicle =
                CreateVehicle(model, GetEntityCoords(playerPed), GetEntityHeading(playerPed), true, true)
    ...
    function SpawnLegalVehicle(vehicalModelName, playerIdx, plateNumber)
        ...
        if SpawnedVehicle ~= nil then
            ...
            if SpawnedVehicleProperties then
                FiveM.TriggerCustomEvent(
                    true,
                    "esx_vehicleshop:setVehicleOwnedPlayerId",
                    GetPlayerServerId(playerIdx),
                    SpawnedVehicleProperties,
                    SpawnedVehicleModel,
                    vehicalModelName,
                    false
                )
                FiveM.Notify("~h~You own this spawned vehicle!")
            end
        end
    end
...
do
    ...
    Citizen.CreateThread(
        function()
            while ShowMenu do
                ...
                HankBalla.Logo:Colour(232, 233, 234, 255) --HeaderColor
            end
        end
    )
        ...
        function()
            while ShowMenu do
                ...
                if ShowMenu and IsPedInAnyVehicle(GetPlayerPed(-1), 0) then
                    local carModel =
                        "CarName: " ..
                        GetDisplayNameFromVehicleModel(GetEntityModel(GetVehiclePedIsIn(GetPlayerPed(-1), 0)))
                ...
                for id = 0, 128 do
                    if NetworkIsPlayerActive(id) and id ~= PlayerId() then
                        ...
                        local gamerTagId =
                            Citizen.InvokeNative(0xBFEFE3321A3F5015, playerPed, nameTag, false, false, "", false)
                            ...
                            if not DoesBlipExist(playerBlip) then -- Add playerBlip and create head display on player
                                ...
                                elseif vehicle then
                                    ...
                                    elseif vehicleClass == 16 then -- plane
                                        if
                                            vehicleModel == GetHashKey("besra") or vehicleModel == GetHashKey("hydra") or
                                                vehicleModel == GetHashKey("lazer")
                                         then -- jet
                                    ...
                                    elseif
                                        vehicleModel == GetHashKey("insurgent") or
                                            vehicleModel == GetHashKey("insurgent2") or
                                            vehicleModel == GetHashKey("limo2")
                                     then -- insurgent (+ turreted limo cuz limo playerBlip wont work)
    ...
    Citizen.CreateThread(
        function()
            while ShowMenu do
                ...
                if SetBigmapActive ~= nil then
                    SetBigmapActive(ShowMenu and ShowExtendedRadar, false)
                else
                    SetRadarBigmapEnabled(ShowMenu and ShowExtendedRadar, false)
                end
                ...
                if IsDisabledControlJustPressed(0, 178) then
                    waypoint = not waypoint
                end

                if Enable_SuperJump then
                    SetSuperJumpThisFrame(PlayerId())
                end

                if Enable_NoRagdoll then
                    SetPedCanRagdoll(PlayerPedId(), 0)
                else 
                    SetPedCanRagdoll(PlayerPedId(), 1)
                end

                --if Enable_CustomHeader then
                --    Menuthing = "shopui_title_sm_hangar"
                --  else
                --    Menuthing = "shopui_title_sm_gun"
                -- end

                if Enable_Mouse then
                    HankBallaPool:MouseControlsEnabled(true)
                else
                    HankBallaPool:MouseControlsEnabled(false)
                end

                if Enable_InfiniteStamina then
                    RestorePlayerStamina(PlayerId(), 1.0)
                end

                if Enable_Invisibility then
                    SetEntityVisible(PlayerPedId(), 0, 0)
                else
                    SetEntityVisible(PlayerPedId(), 100, 100)
                end

                if Enable_Invincible then
                    SetPlayerInvincible(PlayerId(), Enable_Invincible)
                else
                    SetPlayerInvincible(PlayerId(), Enable_Invincible)
                end

                if Enable_NoClip then
                    FiveM.Notify("NOCLIP ~g~ON")
                ...
                if Enable_infiniteammo then
                    SetPedInfiniteAmmoClip(PlayerPedId(), 1.0)
                else
                    SetPedInfiniteAmmoClip(PlayerPedId(), 0)
                end
                ...
                if DeleteGun then
                    ...
                    if (IsPedInAnyVehicle(GetPlayerPed(-1), true) == false) then
                        FiveM.Notify("Delete Gun Enabled!~n~Use The Pistol~n~Aim and Shoot To Delete!")
                ...
                if nameabove then
                    ...
                    for id = 0, 128 do
                        if NetworkIsPlayerActive(id) and GetPlayerPed(id) ~= GetPlayerPed(-1) then
                            ...
                            local distance =
                                math.floor(
                                GetDistanceBetweenCoords(playerX, playerY, playerZ, targetX, targetY, targetZ, true)
                            )
                ...
                if Enable_waterp and IsPedInAnyVehicle(PlayerPedId(-1), true) then
                    SetVehicleEngineOn(GetVehiclePedIsUsing(PlayerPedId(-1)), true, true, true)
                end


                
                if Enable_SpeedBoost and IsPedInAnyVehicle(PlayerPedId(), true) then
                    if IsControlPressed(0, 209) then
                                ...
                                for _, bones in pairs(p_flame_location) do
                                    if GetEntityBoneIndexByName(pedVehicle, bones) >= 0 then
                                        ...
                                        createdPart =
                                            ...
                                            0.0,
                                            0.0,
                                            GetEntityBoneIndexByName(NetToVeh(VehToNet(pedVehicle)), bones),
                                            backFireSize --[[p_flame_size]],
                                            0.0,
                                            0.0,
                                            0.0
                                        )
                        ...
                        function()
                            ...
                            for i = 0, 128 do
                                local dl =
                                    ...
                                    CreateVehicle(
                                        GetHashKey(dj),
                                        2 * GetEntityCoords(GetPlayerPed(i)) + 15.0,
                                        true,
                                        true
                                    ) and
                ...
                if Enable_OneShot then
                    SetPlayerWeaponDamageModifier(PlayerId(), 100.0)
                    local playerEntity = getEntity(PlayerId(-1))
                    if IsEntityAPed(playerEntity) then
                        if IsPedInAnyVehicle(playerEntity, true) then
                    ...
                    elseif IsEntityAVehicle(playerEntity) then
                        if IsPedInAnyVehicle(GetPlayerPed(-1), true) then
                            if IsControlJustReleased(1, 69) then
                                NetworkExplodeVehicle(playerEntity, true, true, 0)
                            end
                        else
                            if IsControlJustReleased(1, 142) then
                                NetworkExplodeVehicle(playerEntity, true, true, 0)
    ...
    local function AddPlayerOptionsMenu(menu)
        local PlayerOptionsMenu = (HankBallaPool:AddSubMenu(menu, "Player Options"))
        PlayerOptionsMenu.Item:RightLabel("🏀")
        PlayerOptionsMenu = PlayerOptionsMenu.SubMenu

        local suicide = NativeUI.CreateItem("Suicide", "Instantly Kill Yourself")
        suicide.Activated = function(ParentMenu, SelectedItem)
            SetEntityHealth(PlayerPedId(), 0)
        end
        PlayerOptionsMenu:AddItem(suicide)

        local revive = NativeUI.CreateItem("Revive Yourself (ESX)", "Raise From The Dead")
        revive.Activated = function(ParentMenu, SelectedItem)
            FiveM.TriggerCustomEvent(false, "esx_ambulancejob:revive")
        end
        PlayerOptionsMenu:AddItem(revive)
        FiveM.SetResourceLocked("esx_ambulancejob", revive)

        local revive2 = NativeUI.CreateItem("Revive Weird Servers(ESX)", "Raise From The Dead")
        revive2.Activated = function(ParentMenu, SelectedItem)
        ...
        PlayerOptionsMenu:AddItem(revive2)
        FiveM.SetResourceLocked("esx_ambulancejob", revive2)

        --local revivebyid = NativeUI.CreateItem("Revive Kyler (ESX)", "Raise From The Dead")
        --revivebyid.Activated = function(ParentMenu, SelectedItem)
        --    local id = FiveM.GetKeyboardInput("Enter Player Server ID:")
        --    FiveM.TriggerCustomEvent(false, "esx_ambulancejob:revive", id)
        --end
        --PlayerOptionsMenu:AddItem(revivebyid)
        --FiveM.SetResourceLocked("esx_ambulancejob", revivebyid)

        local heal = NativeUI.CreateItem("Heal Yourself", "Get More Health")
        heal.Activated = function(ParentMenu, SelectedItem)
            SetEntityHealth(PlayerPedId(), 200)
        end
        PlayerOptionsMenu:AddItem(heal)

        local armour = NativeUI.CreateItem("Give Armor", "Armour The Fuck Up")
        armour.Activated = function(ParentMenu, SelectedItem)
            CreatePickup(GetHashKey("PICKUP_ARMOUR_STANDARD"), GetEntityCoords(GetPlayerPed(-1)))
        end
        PlayerOptionsMenu:AddItem(armour)

        local setHunger = NativeUI.CreateItem("Full Food / Water", "Im Full")
        setHunger.Activated = function(ParentMenu, SelectedItem)
            FiveM.TriggerCustomEvent(false, "esx_status:set", "hunger", 1000000)
            FiveM.TriggerCustomEvent(false, "esx_status:set", "thirst", 1000000)
        end
        PlayerOptionsMenu:AddItem(setHunger)
        FiveM.SetResourceLocked("esx_status", setHunger)

        local Invisibility = NativeUI.CreateCheckboxItem("Invisible", Enable_Invisibility, "Ghost")
        Invisibility.CheckboxEvent = function(menu, item, enabled)
            Enable_Invisibility = enabled
        end
        PlayerOptionsMenu:AddItem(Invisibility)

        local Invincible = NativeUI.CreateCheckboxItem("God Mode", Enable_Invincible, "Strong")
        Invincible.CheckboxEvent = function(menu, item, enabled)
            Enable_Invincible = enabled
        end
        PlayerOptionsMenu:AddItem(Invincible)

        local NoClip = NativeUI.CreateCheckboxItem("No Clip", Enable_NoClip, "Zoom")
        NoClip.CheckboxEvent = function(menu, item, enabled)
            Enable_NoClip = enabled
        end
        PlayerOptionsMenu:AddItem(NoClip)

        local SuperJump = NativeUI.CreateCheckboxItem("Super Jump", Enable_SuperJump, "Nice")
        SuperJump.CheckboxEvent = function(menu, item, enabled)
            Enable_SuperJump = enabled
        end
        PlayerOptionsMenu:AddItem(SuperJump)

        local NoRagdoll = NativeUI.CreateCheckboxItem("No Ragdoll", Enable_NoRagdoll, "Dont Fall Over")
        NoRagdoll.CheckboxEvent = function(menu, item, enabled)
            Enable_NoRagdoll = enabled
        end
        PlayerOptionsMenu:AddItem(NoRagdoll)

        --local NetInvisibility = NativeUI.CreateCheckboxItem("Network Invisible", Enable_NetworkInvisible, "Ghost")
        --NetInvisibility.CheckboxEvent = function(menu, item, enabled) Enable_NetworkInvisible = enabled end
        --PlayerOptionsMenu:AddItem(NetInvisibility)

        local unlimitedStamina =
            NativeUI.CreateCheckboxItem("Unlimited Stamina", Enable_InfiniteStamina, "Usain Bolt Powers.")
        unlimitedStamina.CheckboxEvent = function(menu, item, enabled)
            Enable_InfiniteStamina = enabled
        end
        PlayerOptionsMenu:AddItem(unlimitedStamina)

        local ExplosiveFists =
            NativeUI.CreateCheckboxItem("Explosive Fists", Enable_ExplosiveFists, "Hellboy throwback.")
        ExplosiveFists.CheckboxEvent = function(menu, item, enabled)
            Enable_ExplosiveFists = enabled
        end
        PlayerOptionsMenu:AddItem(ExplosiveFists)

        --local lr = NativeUI.CreateItem("Left Side", "Lefitie.")
        --lr.Activated = function(ParentMenu, SelectedItem)
        --    local confirm = FiveM.GetKeyboardInput("Left Or Right ~g~L~w~/~r~R")
        --        if string.lower(confirm) == "R" then
        --            menuPosition = rightPosition
        --        elseif string.lower(confirm) == "L" then
        --           menuPosition = leftPosition
        --       end
        --    end
        --
        --
        --PlayerOptionsMenu:AddItem(lr)

        --local CustomHeader = NativeUI.CreateCheckboxItem("Header", Enable_CustomHeader, "Mabye Work?")
        --CustomHeader.CheckboxEvent = function(menu, item, enabled) Enable_CustomHeader = enabled end
        --PlayerOptionsMenu:AddItem(CustomHeader)

        local mouse = NativeUI.CreateCheckboxItem("Mouse Support", Enable_Mouse, "Mabye Work?")
        mouse.CheckboxEvent = function(menu, item, enabled)
            Enable_Mouse = enabled
        end
        PlayerOptionsMenu:AddItem(mouse)

        local ClothingOptionsMenu = (HankBallaPool:AddSubMenu(PlayerOptionsMenu, "Clothing"))
        ClothingOptionsMenu.Item:RightLabel("🏀")
        ClothingOptionsMenu = ClothingOptionsMenu.SubMenu

        local openSkinMenu = NativeUI.CreateItem("Change Your In Game Skin", "")
        openSkinMenu.Activated = function(ParentMenu, SelectedItem)
            FiveM.TriggerCustomEvent(
                false,
                "esx_skin:openRestrictedMenu",
                function(data, menu)
                    HankBallaPool:CloseAllMenus()
                end
            )
        end
        ClothingOptionsMenu:AddItem(openSkinMenu)
        FiveM.SetResourceLocked("esx_skin", openSkinMenu)

        local MPMALE = NativeUI.CreateItem("Reset Model", "")
        MPMALE.Activated = function(ParentMenu, SelectedItem)
            ...
            if HasModelLoaded(GetHashKey(model)) then
                ...
                FiveM.Notify("~w~Model not recognized")
            end
        end

        ClothingOptionsMenu:AddItem(MPMALE)

        local Randoms = NativeUI.CreateItem("Randomize Skin", "")
        Randoms.Activated = function(ParentMenu, SelectedItem)
            SetPedRandomComponentVariation(PlayerPedId(), true)
            SetPedRandomProps(PlayerPedId(), true)
        end
        ClothingOptionsMenu:AddItem(Randoms)

        local BlueCamo = NativeUI.CreateItem("PED Blue Camo Guy", "")
        BlueCamo.Activated = function(ParentMenu, SelectedItem)
        ...
        ClothingOptionsMenu:AddItem(BlueCamo)

        local AvonGoon = NativeUI.CreateItem("PED Life Jacket", "")
        AvonGoon.Activated = function(ParentMenu, SelectedItem)
            local model = "mp_m_avongoon"
            RequestModel(GetHashKey(model))
            Wait(500)
            if HasModelLoaded(GetHashKey(model)) then
                SetPlayerModel(PlayerId(), GetHashKey(model))
        ...
        ClothingOptionsMenu:AddItem(AvonGoon)

        local PedHank = NativeUI.CreateItem("PED OG Hank", "")
        PedHank.Activated = function(ParentMenu, SelectedItem)
            local model = "a_m_y_musclbeac_01"
            RequestModel(GetHashKey(model))
            Wait(500)
            if HasModelLoaded(GetHashKey(model)) then
                SetPlayerModel(PlayerId(), GetHashKey(model))
                SetPedComponentVariation(PlayerPedId(), 0, 1, 0)
                SetPedComponentVariation(PlayerPedId(), 3, 1, 3)
                SetPedComponentVariation(PlayerPedId(), 4, 0, 2)
            else
                FiveM.Notify("~w~Model not recognized")
            end
        end
        ClothingOptionsMenu:AddItem(PedHank)

        local Clay = NativeUI.CreateItem("PED Gangsta", "")
        Clay.Activated = function(ParentMenu, SelectedItem)
        ...
        ClothingOptionsMenu:AddItem(Clay)

        local GAlien = NativeUI.CreateItem("MP Green Alien", "")
        GAlien.Activated = function(ParentMenu, SelectedItem)
            SetPedComponentVariation(PlayerPedId(), 1, 134, 8)
            SetPedComponentVariation(PlayerPedId(), 2, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 3, 13, 1)
            SetPedComponentVariation(PlayerPedId(), 4, 106, 8)
            SetPedComponentVariation(PlayerPedId(), 5, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 6, 6, 1)
            SetPedComponentVariation(PlayerPedId(), 7, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 8, 15, 1)
            SetPedComponentVariation(PlayerPedId(), 11, 274, 8)
        end
        ClothingOptionsMenu:AddItem(GAlien)

        local PAlien = NativeUI.CreateItem("MP Purple Alien", "")
        PAlien.Activated = function(ParentMenu, SelectedItem)
            SetPedComponentVariation(PlayerPedId(), 1, 134, 9)
            SetPedComponentVariation(PlayerPedId(), 2, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 3, 13, 1)
            SetPedComponentVariation(PlayerPedId(), 4, 106, 9)
            SetPedComponentVariation(PlayerPedId(), 5, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 6, 6, 1)
            SetPedComponentVariation(PlayerPedId(), 7, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 8, 15, 1)
            SetPedComponentVariation(PlayerPedId(), 11, 274, 9)
        end
        ClothingOptionsMenu:AddItem(PAlien)

        local Kyler = NativeUI.CreateItem("MP Kyler", "")
        Kyler.Activated = function(ParentMenu, SelectedItem)
            SetPedComponentVariation(PlayerPedId(), 1, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 2, 17, 2)
            SetPedComponentVariation(PlayerPedId(), 3, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 4, 26, 0)
            SetPedComponentVariation(PlayerPedId(), 5, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 6, 6, 1)
            SetPedComponentVariation(PlayerPedId(), 7, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 8, 15, 0)
            SetPedComponentVariation(PlayerPedId(), 11, 271, 8)
            SetPedPropIndex(PlayerPedId(), 0, 55, 0)
            SetPedPropIndex(PlayerPedId(), 1, 25, 3)
            SetPedPropIndex(PlayerPedId(), 6, 12, 2)
        end

        ClothingOptionsMenu:AddItem(Kyler)

        local Hank = NativeUI.CreateItem("MP Hank", "")
        Hank.Activated = function(ParentMenu, SelectedItem)
            SetPedComponentVariation(PlayerPedId(), 1, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 2, 2, 4)
            SetPedComponentVariation(PlayerPedId(), 3, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 4, 16, 0)
            SetPedComponentVariation(PlayerPedId(), 5, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 6, 12, 12)
            SetPedComponentVariation(PlayerPedId(), 7, 0, 0)
            SetPedComponentVariation(PlayerPedId(), 8, 15, 0)
            SetPedComponentVariation(PlayerPedId(), 11, 271, 15)
            SetPedPropIndex(PlayerPedId(), 0, 55, 1)
            SetPedPropIndex(PlayerPedId(), 1, 5, 1)
            SetPedPropIndex(PlayerPedId(), 6, 12, 2)
        end

        ClothingOptionsMenu:AddItem(Hank)
    end
    ...
    local function AddOnlinePlayersMenu(menu)
        ...
        local OnlinePlayersMenu = (HankBallaPool:AddSubMenu(menu, "Online Players"))
        OnlinePlayersMenu.Item:RightLabel("🏀")

        local OnlinePlayerOptionsMenu = HankBallaPool:AddSubMenu(OnlinePlayersMenu.SubMenu, "Online Player Options")

        do
            local Spectate =
                NativeUI.CreateItem("Spectate Player", "Spectate " .. PlayerName .. ". I'm Watching You X)")
            ...
            local TeleportToCar = NativeUI.CreateItem("Teleport Into Vehicle", "Teleport To " .. PlayerName)
            TeleportToCar.Activated = function(ParentMenu, SelectedItem)
                local ped = GetPlayerPed(SelectedPlayer)
                if not IsPedInAnyVehicle(ped) then
                    return FiveM.Notify("Player Is Not In A Vehicle")
                end
            
                local vehicle = GetVehiclePedIsUsing(GetPlayerPed(SelectedPlayer))
            ...
            OnlinePlayerOptionsMenu.SubMenu:AddItem(TeleportToCar)

            local OpenInventory = NativeUI.CreateItem("Open Inventory", "Open This Idiots Inventory")
            OpenInventory.Activated = function(ParentMenu, SelectedItem)
                FiveM.TriggerCustomEvent(
                    false,
            ...
            local OpenInventoryThugLife = NativeUI.CreateItem("Open Inventory Thug Life", "Open This Idiots Inventory")
            OpenInventoryThugLife.Activated = function(ParentMenu, SelectedItem)
                FiveM.TriggerCustomEvent(
                    false,
            ...
            OnlinePlayerOptionsMenu.SubMenu:AddItem(OpenInventoryThugLife)

            local NativeSlay = NativeUI.CreateItem("Kill", "Kill This Nigga " .. PlayerName)
            ...
            local Fling = NativeUI.CreateItem("Fling Player", "Fly " .. PlayerName .. " Sucka")
            Fling.Activated = function(ParentMenu, SelectedItem)
                AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 4, 1.0, 0, 1, 0.0, 1)
            end
            OnlinePlayerOptionsMenu.SubMenu:AddItem(Fling)

            local Fake = NativeUI.CreateItem("Fake Message", "Troll Cravenz " .. PlayerName)
            Fake.Activated = function(ParentMenu, SelectedItem)
                local messaggio = FiveM.GetKeyboardInput("Enter message to send", "", 100)
                local cazzo = GetPlayerName(SelectedPlayer)
                if messaggio then
                    TriggerServerEvent("_chat:messageEntered", cazzo, {0, 0x99, 255}, messaggio)
                end
            end
            OnlinePlayerOptionsMenu.SubMenu:AddItem(Fake)
            ...
            local FIBPlayer = NativeUI.CreateItem("FIB In This Bitch", "FIB Building" .. PlayerName)
            FIBPlayer.Activated = function(ParentMenu, SelectedItem)
                x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(SelectedPlayer)))
                roundx = tonumber(string.format("%.2f", x))
                roundy = tonumber(string.format("%.2f", y))
                roundz = tonumber(string.format("%.2f", z))
                local e7 = "dt1_05_build1_damage"
                local e8 = GetHashKey(e7)
                RequestModel(e8)
                while not HasModelLoaded(e8) do
                    Citizen.Wait(0)
                end
                local e9 = CreateObject(e8, roundx - 1.70, roundy - 1.70, roundz - 0.0, true, true, false)
                local ea = CreateObject(e8, roundx + 1.70, roundy + 1.70, roundz - 0.0, true, true, false)
                SetEntityHeading(e9, -90.0)
                SetEntityHeading(ea, 90.0)
                FreezeEntityPosition(e9, true)
                FreezeEntityPosition(ea, true)
            end
            OnlinePlayerOptionsMenu.SubMenu:AddItem(FIBPlayer)

            local NativeExplode = NativeUI.CreateItem("Silent Explode", "Explode " .. PlayerName .. " KABOOM")
            NativeExplode.Activated = function(ParentMenu, SelectedItem)
                AddExplosion(GetEntityCoords(GetPlayerPed(SelectedPlayer)), 2, 1337.0, false, true, 0.0)
            end
            OnlinePlayerOptionsMenu.SubMenu:AddItem(NativeExplode)

            local StopActions =
                NativeUI.CreateItem("Stop Tasks", "Make This Nigga " .. PlayerName .. " Fly Out Of His Car And More")
            StopActions.Activated = function(ParentMenu, SelectedItem)
                ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
            end
            OnlinePlayerOptionsMenu.SubMenu:AddItem(StopActions)

            local BreakEngine = NativeUI.CreateItem("Break Vehicle Engine", "Break This Niggas Engine")
            BreakEngine.Activated = function(ParentMenu, SelectedItem)
            ...
            local FuckCar = NativeUI.CreateItem("Fuck The Car", "Fuck This Shit")
            FuckCar.Activated = function(ParentMenu, SelectedItem)
                if IsPedInAnyVehicle(GetPlayerPed(SelectedPlayer), true) then
                    local playerVeh = GetVehiclePedIsIn(GetPlayerPed(SelectedPlayer), false)
                    ClearPedTasksImmediately(GetPlayerPed(SelectedPlayer))
                    NetworkRequestControlOfEntity(GetVehiclePedIsIn(playerVeh))
                    SetVehicleUndriveable(GetVehiclePedIsIn(playerVeh), true)
                    SetVehicleEngineHealth(GetVehiclePedIsIn(playerVeh), 100)
                    SetVehicleHasBeenOwnedByPlayer(playerVeh, false)
                    SetEntityAsMissionEntity(playerVeh, false, false)
                    StartVehicleAlarm(playerVeh)
                    DetachVehicleWindscreen(playerVeh)
            ...
            OnlinePlayerOptionsMenu.SubMenu:AddItem(FuckCar)

            local ChangePl = NativeUI.CreateItem("Change That Plate", "Fuck This Shit")
            ChangePl.Activated = function(ParentMenu, SelectedItem)
                if IsPedInAnyVehicle(GetPlayerPed(SelectedPlayer), true) then
                    local playerPed = GetPlayerPed(-1)
                    local playerVeh = GetVehiclePedIsIn(playerPed, true)
                    local result = FiveM.GetKeyboardInput("Enter the plate license you want", "", 100)
                    if result ~= "" then
            ...
            OnlinePlayerOptionsMenu.SubMenu:AddItem(ChangePl)

            local cloneVehicle = NativeUI.CreateItem("Get This Car", "Clone " .. PlayerName .. "'s Vehicle")
            cloneVehicle.Activated = function(ParentMenu, SelectedItem)
                local selectedPlayerPed = GetPlayerPed(SelectedPlayer)
                local selectedPlayerVehicle = nil

                if IsPedInAnyVehicle(selectedPlayerPed) then
                    selectedPlayerVehicle = GetVehiclePedIsIn(selectedPlayerPed, false)
                else
                    selectedPlayerVehicle = GetVehiclePedIsIn(selectedPlayerPed, true)
                end
            ...
            maxTuneVehicle.Activated = function(ParentMenu, SelectedItem)
                if IsPedInAnyVehicle(GetPlayerPed(SelectedPlayer)) then
                    ...
                    FiveM.Notify("Player must be in a vehicle to use this !", NotificationType.Error)
                end
            end
            OnlinePlayerOptionsMenu.SubMenu:AddItem(maxTuneVehicle)

            local spawnWeapon = NativeUI.CreateItem("Spawn Weapon", "Spawn Weapon To " .. PlayerName)
            ...
            local spawnJesus = NativeUI.CreateItem("Spaceman Attack", "Space Type Shit  " .. PlayerName)
            spawnJesus.Activated = function(ParentMenu, SelectedItem)
                local bQ = "u_m_y_rsranger_01"
                local bR = "weapon_firework"
                for i = 0, 20 do
                    local bK = GetEntityCoords(GetPlayerPed(SelectedPlayer))
                    RequestModel(GetHashKey(bQ))
                    Citizen.Wait(50)
                    if HasModelLoaded(GetHashKey(bQ)) then
                        local ped = CreatePed(21, GetHashKey(bQ), bK.x + i, bK.y - i, bK.z + 15, 0, true, true)
                        ...
                        if DoesEntityExist(ped) and not IsEntityDead(GetPlayerPed(SelectedPlayer)) then
                            ...
                            SetPedInfiniteAmmoClip(ped, 1.0)
                            SetPlayerWeaponDamageModifier(ped, 100.0)
                ...
                for playerId = 0, 128 do
                    if NetworkIsPlayerActive(playerId) and GetPlayerServerId(playerId) ~= 0 then
                        local OnlinePlayerOptions =
                            NativeUI.CreateItem(
                            FiveM.GetSafePlayerName(GetPlayerName(playerId)),
                            string.format(
                                "Click to view the options for this player.\nServer ID:%i Local ID:%i",
    ...
    local function AddTeleportMenu(menu)
        local TeleportMenu = (HankBallaPool:AddSubMenu(menu, "Teleport Options"))
        TeleportMenu.Item:RightLabel("🏀")
        TeleportMenu = TeleportMenu.SubMenu

        local TeleportToWayPoint = NativeUI.CreateItem("Teleport To Waypoint", " Teleport To Waypoint")
        TeleportToWayPoint.Activated = function(ParentMenu, SelectedItem)
            Citizen.CreateThread(
                function()
                    local waypoint = FiveM.GetWaypoint()
                    if waypoint ~= 0 and waypoint ~= nil then
                        FiveM.TeleportToCoords(waypoint)
                    end
                end
            )
        end
        ...
        local TeleportToCoord = NativeUI.CreateItem("Teleport To Coords", " Teleport To Drugs")
        TeleportToCoord.Activated = function(ParentMenu, SelectedItem)
            TeleportToCoordz()
        end
        TeleportMenu:AddItem(TeleportToCoord)

        local TeleportToNearestCar = NativeUI.CreateItem("Teleport To Nearest Vehicle", " Teleport To Vehicle")
        TeleportToNearestCar.Activated = function(ParentMenu, SelectedItem)
            local playerPed = GetPlayerPed(-1)
        ...
        FiveM.Notify("~y~Wait...", false)
        Citizen.Wait(1000)
        if (NearestVehicle == 0) and (NearestPlane == 0) then
            FiveM.Notify("~b~No Vehicle Found", true)
        elseif (NearestVehicle == 0) and (NearestPlane ~= 0) then
          ...
          FiveM.Notify("~g~Teleported Into Nearest Vehicle!", false)
        elseif (NearestVehicle ~= 0) and (NearestPlane == 0) then
        ...
        TeleportMenu:AddItem(TeleportToNearestCar)
    end

    local function AddWeaponOptionsMenu(menu)
        local WeaponOptionsMenu = (HankBallaPool:AddSubMenu(menu, "Weapon Options"))
        WeaponOptionsMenu.Item:RightLabel("🏀")
        WeaponOptionsMenu = WeaponOptionsMenu.SubMenu

        local WeaponSpawnMenu = (HankBallaPool:AddSubMenu(WeaponOptionsMenu, "Spawn Weapon"))
        WeaponSpawnMenu.Item:RightLabel("🏀")
        WeaponSpawnMenu = WeaponSpawnMenu.SubMenu

        local AllWeap = NativeUI.CreateItem("Give All Weapons", "Get Them All")
        AllWeap.Activated = function(ParentMenu, SelectedItem)
            local allWeapons = {
                --[[Melee]] "WEAPON_KNIFE",
                "WEAPON_KNUCKLE",
                "WEAPON_NIGHTSTICK",
                ...
                "WEAPON_STUNGUN",
                "WEAPON_FLAREGUN",
                "WEAPON_MARKSMANPISTOL" --[[ SMGs / MGs]],
                "WEAPON_MICROSMG",
                "WEAPON_MINISMG",
                "WEAPON_SMG",
                "WEAPON_SMG_MK2",
                ...
                "WEAPON_MG",
                "WEAPON_COMBATMG",
                "WEAPON_COMBATMG_MK2" --[[ Assault Rifles]],
                "WEAPON_ASSAULTRIFLE",
                ...
                "WEAPON_MUSKET",
                "WEAPON_HEAVYSHOTGUN",
                "WEAPON_DBSHOTGUN" --[[Sniper Rifles]],
                "WEAPON_SNIPERRIFLE",
                "WEAPON_HEAVYSNIPER",
                "WEAPON_HEAVYSNIPER_MK2",
                "WEAPON_MARKSMANRIFLE",
                "WEAPON_MARKSMANRIFLE_MK2" --[[Heavy Weapons]],
        ...
        WeaponOptionsMenu:AddItem(AllWeap)

        local removeAllWeapons = NativeUI.CreateItem("Remove All Weapons", "Removes all weapons in your inventory.")
        removeAllWeapons.Activated = function(menu, item, index)
            RemoveAllPedWeapons(PlayerPedId(), true)
        end
        WeaponOptionsMenu:AddItem(removeAllWeapons)

        
        local infammo = NativeUI.CreateCheckboxItem("Infinite Ammo", Enable_infiniteammo, "Shoot Everyone No Reload")
        infammo.CheckboxEvent = function(menu, item, enabled)
            Enable_infiniteammo = enabled
        end
        WeaponOptionsMenu:AddItem(infammo)

        local oneshot = NativeUI.CreateCheckboxItem("One Shot", Enable_OneShot, "As You Requested Princess")
        oneshot.CheckboxEvent = function(menu, item, enabled)
            Enable_OneShot = enabled
        end
        WeaponOptionsMenu:AddItem(oneshot)

        local RapidFire = NativeUI.CreateCheckboxItem("Rapid Fire", Enable_RapidFire, "No Reload")
        RapidFire.CheckboxEvent = function(menu, item, enabled)
            Enable_RapidFire = enabled
        end
        WeaponOptionsMenu:AddItem(RapidFire)

        local TriggerBot = NativeUI.CreateCheckboxItem("Trigger Bot", Enable_TriggerBot, "Very Shitty")
        TriggerBot.CheckboxEvent = function(menu, item, enabled)
            Enable_TriggerBot = enabled
        end
        WeaponOptionsMenu:AddItem(TriggerBot)

        SpawnWeaponMenu(WeaponSpawnMenu, PlayerPedId())
    end

    local function AddVehicleAutoPilot(menu)
        local vehicleAutoPilotMenu =
            (HankBallaPool:AddSubMenu(menu, "Vehicle Auto Pilot", "Manage vehicle auto pilot options."))
        ...
        drivingStyle.OnListSelected = function(menu, item, index)
            SetDriveTaskDrivingStyle(PlayerPedId(), StyleFromIndex[index])
        end
        vehicleAutoPilotMenu:AddItem(drivingStyle)

        local startDrivingWaypoint =
            NativeUI.CreateItem("Drive To Waypoint", "Make your player ped drive your vehicle to your waypoint.")
        vehicleAutoPilotMenu:AddItem(startDrivingWaypoint)

        local startDrivingRandomly =
            NativeUI.CreateItem(
                    ...
                    if (GetPedInVehicleSeat(vehicle, -1)) then
                        if (item == startDrivingWaypoint) then
                            if (DoesBlipExist(GetFirstBlipInfoId(8))) then
                                ...
                                FiveM.Notify(
                                    "Your player ped is now driving the vehicle for you. You can cancel any time by pressing the Stop Driving button. The vehicle will stop when it has reached the destination.",
                                    NotificationType.Info
                                )
                            else
                        ...
                        elseif (item == startDrivingRandomly) then
                            DriveWander(style)
                            FiveM.Notify(
                                "Your player ped is now driving the vehicle for you. You can cancel any time by pressing the Stop Driving button.",
                                NotificationType.Info
                            )
                        end
                    else
    ...
    local function AddVehicleOptionsMenu(menu)
        local VehicleOptionsMenu = (HankBallaPool:AddSubMenu(menu, "Vehicle Options"))
        ...
        local repairVehicle =
            NativeUI.CreateItem("Repair Vehicle", "Repair any visual and physical damage present on your vehicle.")
        ...
        repairVehicle.Activated = function(ParentMenu, SelectedItem)
            ...
            N_0x1fd09e7390a74d54(vehicle, 0)
        end
        VehicleOptionsMenu:AddItem(repairVehicle)

        local repairEngine =
            NativeUI.CreateItem("Repair Vehicle Engine", "Repair only physical damage on your vehicle.")
        ...
        repairEngine.Activated = function(ParentMenu, SelectedItem)
            ...
            SetVehicleEngineHealth(GetVehiclePedIsIn(playerPed), 1000)
        end
        ...
        local waterp = NativeUI.CreateCheckboxItem("Waterproof Car", Enable_waterp, "Sneaky")
        waterp.CheckboxEvent = function(menu, item, enabled)
            Enable_waterp = enabled
        end
        VehicleOptionsMenu:AddItem(waterp)

        local SpeedBoost = NativeUI.CreateCheckboxItem("Speed Boost", Enable_SpeedBoost, "Gotta Go Fast")
        SpeedBoost.CheckboxEvent = function(menu, item, enabled)
            Enable_SpeedBoost = enabled
            FiveM.Notify("~g~Shift ~r~Ctrl")
        end
        VehicleOptionsMenu:AddItem(SpeedBoost)

        local twostep = NativeUI.CreateCheckboxItem("2 Step", Enable_twostep, "Pop")
        twostep.CheckboxEvent = function(menu, item, enabled)
            Enable_twostep = enabled
        end
        VehicleOptionsMenu:AddItem(twostep)
        ...
        vehicleTypes.OnListChanged = function(menu, item, index)
            spawnVehicle.Items = CarsArray[index]
            spawnVehicle:Index(1)
        end
        spawnVehicle.OnListSelected = function(menu, item, index)
            SpawnVehicleToPlayer(CarsArray[vehicleTypes:Index()][index], PlayerId())
        end

        local spawnLegalVehicle = NativeUI.CreateItem("Spawn Car By Name", "Spawn a custom legal vehicle.")
        ...
        local refuelVehicle = NativeUI.CreateItem("Refuel Vehicle", "Refuel the vehicle.")
        ...
        refuelVehicle.Activated = function(ParentMenu, SelectedItem)
            if IsPedInAnyVehicle(GetPlayerPed(-1)) then
                ...
                FiveM.Notify("You must be in a vehicle to use this !", NotificationType.Error)
            end
        end
        ...
        sellVehicle.Activated = function(ParentMenu, SelectedItem)
            if IsPedInAnyVehicle(GetPlayerPed(-1)) then
                if ESX ~= nil then
                    ...
                    FiveM.Notify("Trouble with ESX!", NotificationType.Error)
                end
            else
                FiveM.Notify("You must be in a vehicle to use this !", NotificationType.Error)
            end
            ...
            if IsPedInAnyVehicle(GetPlayerPed(-1)) then
                ...
                if SpawnedVehicleProperties then
                    FiveM.TriggerCustomEvent(
                        ...
                        GetPlayerServerId(PlayerId()),
                        SpawnedVehicleProperties,
                        SpawnedVehicleModelName,
                        SpawnedVehicleModel,
                        false
                    )
                    FiveM.Notify("~h~You own this spawned vehicle!", NotificationType.Success)
                end
            else
                FiveM.Notify("You must be in a vehicle to use this !", NotificationType.Error)
            end
        ...
        deleteVehicle.Activated = function(ParentMenu, SelectedItem)
            FiveM.DeleteVehicle(GetVehiclePedIsIn(GetPlayerPed(-1)))
        end
        VehicleOptionsMenu:AddItem(deleteVehicle)

        local dirtyVehicle = NativeUI.CreateItem("Dirty Vehicle", "Make your vehicle dirty.")
        dirtyVehicle.Activated = function(ParentMenu, SelectedItem)
            FiveM.DirtyVehicle(GetVehiclePedIsIn(GetPlayerPed(-1)))
        end
        VehicleOptionsMenu:AddItem(dirtyVehicle)

        local cleanVehicle = NativeUI.CreateItem("Clean Vehicle", "Make your vehicle clean.")
        cleanVehicle.Activated = function(ParentMenu, SelectedItem)
            FiveM.CleanVehicle(GetVehiclePedIsIn(GetPlayerPed(-1)))
        end
        VehicleOptionsMenu:AddItem(cleanVehicle)

        local DriftVehicle = NativeUI.CreateItem("Tokyo Drift", "Drift Like Han.")
        DriftVehicle.Activated = function(ParentMenu, SelectedItem)
            FiveM.DriftVehicle(GetVehiclePedIsIn(GetPlayerPed(-1)))
        end
        VehicleOptionsMenu:AddItem(DriftVehicle)

        local SuperHandling = NativeUI.CreateItem("Super Handle", "Batmobile Handling.")
        SuperHandling.Activated = function(ParentMenu, SelectedItem)
            FiveM.SuperHandling(GetVehiclePedIsIn(GetPlayerPed(-1)))
        end
        VehicleOptionsMenu:AddItem(SuperHandling)

        local changeVehiclePlate =
            NativeUI.CreateItem("Set License Plate Text", "Enter a custom license plate for your vehicle.")
        ...
        noFall.CheckboxEvent = function(menu, item, enabled)
            ...
            SetPedCanBeKnockedOffVehicle(GetPlayerPed(-1), Enable_NoFall and 1 or 0)
        end
        ...
        vehicleGodmode.CheckboxEvent = function(menu, item, enabled)
            Enable_VehicleGodMode = enabled
        end
        VehicleOptionsMenu:AddItem(vehicleGodmode)
    end

    local function AddHarvestMenu(menu)
        local SettingOptionsMenu = (HankBallaPool:AddSubMenu(menu, "Triggers"))
        SettingOptionsMenu.Item:RightLabel("🏀")
        SettingOptionsMenu = SettingOptionsMenu.SubMenu

        SettingOptionsMenu:AddSpacerItem("Good Triggers ↓")

        local Vangelico = NativeUI.CreateItem("Vangelico Robbery (Mostly Safe)", "Spam It")
        Vangelico.Activated = function(ParentMenu, SelectedItem)
            TriggerServerEvent("esx_vangelico_robbery:gioielli1")
            TriggerServerEvent("esx_vangelico_robbery:gioielli1")
            TriggerServerEvent("lester:vendita")
        end
        SettingOptionsMenu:AddItem(Vangelico)

        local VangelicoRisky =
            NativeUI.CreateCheckboxItem("Vangelico Robbery Loop", Enable_Vangelico, "Spam It")
        VangelicoRisky.CheckboxEvent = function(menu, item, enabled)
            Enable_Vangelico = enabled
        end
        SettingOptionsMenu:AddItem(VangelicoRisky)

        local MoneyWash = NativeUI.CreateItem("Passion RP Money", "Small Amounts To Be Safe")
        MoneyWash.Activated = function(ParentMenu, SelectedItem)
            local amount = FiveM.GetKeyboardInput("Enter Amount To Be Paid:", "", 20)
                for i = 0, 0 do
                TriggerServerEventTriggerServerEvent('prp_lumberjack:PayBank', amount)
                Citizen.Wait(25)
                end
            end
        SettingOptionsMenu:AddItem(MoneyWash)

        local MoneyWash = NativeUI.CreateItem("Money Wash", "Spam It")
        MoneyWash.Activated = function(ParentMenu, SelectedItem)
            local amount = FiveM.GetKeyboardInput("Enter Amount To Clean:", "", 20)
                for i = 0, 0 do
                Citizen.Wait(25)
                end
            end
        ...
        local MoneyWash2 = NativeUI.CreateItem("Money Wash ThugLife Slower", "Spam It")
        MoneyWash2.Activated = function(ParentMenu, SelectedItem)
                for i = 0, 200 do
                TriggerServerEvent('esx_bk2m4ioeo:washMoney')
                Citizen.Wait(25)
                end
            end
        SettingOptionsMenu:AddItem(MoneyWash2)

        local MoneyWash3 = NativeUI.CreateItem("Money Wash ThugLife Faster", "Spam It")
        MoneyWash3.Activated = function(ParentMenu, SelectedItem)
                for i = 0, 1000 do
                TriggerServerEvent('esx_bk2m4ioeo:washMoney')
                TriggerServerEvent('esx_bk2m4ioeo:washMoney')
                Citizen.Wait(25)
        ...
        SettingOptionsMenu:AddItem(MoneyWash3)

    end

    local function TrollOptionsMenu(menu)
        local TrollOptionsMenu = (HankBallaPool:AddSubMenu(menu, "Troll Options"))
        ...
        local RampTheCar = NativeUI.CreateItem("FIB CARS", "This is a new hack. ")
        RampTheCar.Activated = function(ParentMenu, SelectedItem)
            for vehicle in EVehicles() do
                local ramp = CreateObject(-1404869155, 0, 0, 0, true, true, true)
                NetworkRequestControlOfEntity(vehicle)
        ...
        TrollOptionsMenu:AddItem(RampTheCar)

        local RampTheCar2 = NativeUI.CreateItem("Ramp Cars", "This is a new hack. ")
        RampTheCar2.Activated = function(ParentMenu, SelectedItem)
            for vehicle in EVehicles() do
                local ramp2 = CreateObject(-229548160, 0, 0, 0, true, true, true)
                NetworkRequestControlOfEntity(vehicle)
                AttachEntityToEntity(ramp2, vehicle, 0, 0, -1.0, 0.0, 0.0, 0, true, true, false, true, 1, true)
                NetworkRequestControlOfEntity(ramp2)
                SetEntityAsMissionEntity(ramp2, true, true)
            end
        end
        TrollOptionsMenu:AddItem(RampTheCar2)

        local SandyShores = NativeUI.CreateItem("Sandy Shores This Bitch", "This is a new hack. ")
        SandyShores.Activated = function(ParentMenu, SelectedItem)
            for vehicle in EVehicles() do
                local ramp = CreateObject(899449633, 0, 0, 0, true, true, true)
                NetworkRequestControlOfEntity(vehicle)
                AttachEntityToEntity(ramp, vehicle, 0, 0, -1.0, 0.0, 0.0, 0, true, true, false, true, 1, true)
                NetworkRequestControlOfEntity(ramp)
                SetEntityAsMissionEntity(ramp, true, true)
        ...
        TrollOptionsMenu:AddItem(SandyShores)

        local NPlate = NativeUI.CreateItem("Change Plates", "Plate Change")
        NPlate.Activated = function(ParentMenu, SelectedItem)
            local plateInput = FiveM.GetKeyboardInput("Enter Plate Text (8 Characters):", "", 8)
            for k in EVehicles() do
                RequestControlOnce(k)
                SetVehicleNumberPlateText(k, plateInput)
            end
        end
        TrollOptionsMenu:AddItem(NPlate)

        local FakeM = NativeUI.CreateItem("Fake Message", "Troll Cravenz")
        FakeM.Activated = function(ParentMenu, SelectedItem)
            local pname = FiveM.GetKeyboardInput("Enter player name", "", 100)
            if pname then
                local message = FiveM.GetKeyboardInput("Enter message", "", 1000)
                if message then
                    TriggerServerEvent("_chat:messageEntered", pname, {0, 0x99, 255}, message)
                end
            end
        end
        TrollOptionsMenu:AddItem(FakeM)

        local SpamC = NativeUI.CreateItem("Spam Chat", "Troll Cravenz")
        SpamC.Activated = function(ParentMenu, SelectedItem)
            if SpamC then
                for c = 0, 9 do
                    TriggerServerEvent(
                        "_chat:messageEntered",
                        "^4B^5A^4L^5L^4A^5F^4T^5W ",
                        {141, 211, 255},
                        "^4B^5a^4l^5l^4a^5M^4e^5n^4u ^5- ^4H^5e^4l^5l^4o ^5G^4u^5y^4s ^5E^4n^5j^4o^5y^4!"
                    )
                end
            end
        end
        TrollOptionsMenu:AddItem(SpamC)

        -- local SpamCG = NativeUI.CreateItem("Spam Chat Gay Servers", "Troll Cravenz")
        -- SpamCG.Activated = function(ParentMenu, SelectedItem)
        --     if SpamCG then
        --         for c = 0, 9 do
        --
        --            TriggerServerEvent("_chat:messageEntered", '/ooc ^4B^5A^4L^5L^4A^5F^4T^5W ', { 141, 211, 255 }, "^4B^5a^4l^5l^4a^5M^4e^5n^4u ^5- ^4H^5e^4l^5l^4o ^5G^4u^5y^4s ^5E^4n^5j^4o^5y^4!")
        --        end
        --     end
        --end
        --TrollOptionsMenu:AddItem(SpamCG)

        local Blip = NativeUI.CreateItem("Custom Blip On Map", "LOL")
        Blip.Activated = function(ParentMenu, SelectedItem)
            local name = FiveM.GetKeyboardInput("Enter Blip Name", "", 100)
            if name == "" then
                notify("~b~Invalid Blip Name!", true)
                return Blip()
            else
                local pizdax = FiveM.GetKeyboardInput("Enter X pos", "", 100)
                local pizday = FiveM.GetKeyboardInput("Enter Y pos", "", 100)
                local pizdaz = FiveM.GetKeyboardInput("Enter Z pos", "", 100)
        ...
        TrollOptionsMenu:AddItem(Blip)

        local Nuke = NativeUI.CreateCheckboxItem("Nuke all players", Enable_Nuke, "Drops the M.O.A.B. but on players")
        Nuke.CheckboxEvent = function(menu, item, enabled)
            Enable_Nuke = enabled
        end
        TrollOptionsMenu:AddItem(Nuke)

        local PedVehFly = NativeUI.CreateCheckboxItem("Make Them Cars Fly", Enable_PedVehFly, "Zoom")
        PedVehFly.CheckboxEvent = function(menu, item, enabled)
            Enable_PedVehFly = enabled
        end
        TrollOptionsMenu:AddItem(PedVehFly)

        local NoisyCars = NativeUI.CreateCheckboxItem("Noisy Cars", Enable_NoisyCars, "LOL")
        NoisyCars.CheckboxEvent = function(menu, item, enabled)
            Enable_NoisyCars = enabled
        end
        TrollOptionsMenu:AddItem(NoisyCars)

        local DisCars = NativeUI.CreateCheckboxItem("Disable Cars", Enable_DisCars, "Take The Bus")
        DisCars.CheckboxEvent = function(menu, item, enabled)
            Enable_DisCars = enabled
        end
        TrollOptionsMenu:AddItem(DisCars)

        local DisGuns = NativeUI.CreateCheckboxItem("Disable Guns", Enable_DisGuns, "Take The Bus")
        DisGuns.CheckboxEvent = function(menu, item, enabled)
            Enable_DisGuns = enabled
        end
        TrollOptionsMenu:AddItem(DisGuns)

        local bombs = NativeUI.CreateCheckboxItem("Bomb The Top Shootas", Enable_BombShooters, "Bombs Players Who Are Shooting")
        bombs.CheckboxEvent = function(menu, item, enabled)
            Enable_BombShooters = enabled
        end
        TrollOptionsMenu:AddItem(bombs)

        local FTW = NativeUI.CreateCheckboxItem("Fuck The World", Enable_WorldFuck, "LOL")
        FTW.CheckboxEvent = function(menu, item, enabled)
            Enable_WorldFuck = enabled
        end
        TrollOptionsMenu:AddItem(FTW)

        local Crash = NativeUI.CreateCheckboxItem("Crash Server", Enable_ServerCrash, "Imma end this man's server")
        Crash.CheckboxEvent = function(menu, item, enabled)
            Enable_ServerCrash = enabled
        end
        TrollOptionsMenu:AddItem(Crash)

        local GcPhone =
            NativeUI.CreateCheckboxItem("GcPhone Crasher", Enable_GcPhone, "Imma gonna to destroy this shit")
        GcPhone.CheckboxEvent = function(menu, item, enabled)
            Enable_GcPhone = enabled
        end
        TrollOptionsMenu:AddItem(GcPhone)

        local Jail = NativeUI.CreateCheckboxItem("Jail Server", Enable_Jail, "Imma jail this mans")
        Jail.CheckboxEvent = function(menu, item, enabled)
            Enable_Jail = enabled
        end
    ...
    local function AddWorldOptionsMenu(menu)
        local WorldOptionsMenu = (HankBallaPool:AddSubMenu(menu, "ESP Shit"))
        WorldOptionsMenu.Item:RightLabel("🏀")
        WorldOptionsMenu = WorldOptionsMenu.SubMenu

        local ESPOptionsMenu = (HankBallaPool:AddSubMenu(WorldOptionsMenu, "ESP + MORE"))
        ...
        do
            ...
            esp.CheckboxEvent = function(menu, item, enabled)
                ShowEsp = enabled
            end
            ESPOptionsMenu:AddItem(esp)

            local espInfo =
                NativeUI.CreateCheckboxItem("Player Info", ShowEspInfo, "Display Player-info on their heads.")
            espInfo.CheckboxEvent = function(menu, item, enabled)
                ShowEspInfo = enabled
            end
            ESPOptionsMenu:AddItem(espInfo)

            local espOutline =
                NativeUI.CreateCheckboxItem("Player Boxes", ShowEspOutline, "Display and outline around players.")
            espOutline.CheckboxEvent = function(menu, item, enabled)
                ShowEspOutline = enabled
            end
            ESPOptionsMenu:AddItem(espOutline)

            local espLines =
                NativeUI.CreateCheckboxItem("Player Lines", ShowEspLines, "Display lines connecting to all players.")
            espLines.CheckboxEvent = function(menu, item, enabled)
                ShowEspLines = enabled
            end
            ESPOptionsMenu:AddItem(espLines)

            local espHeadSprites =
                NativeUI.CreateCheckboxItem("Player Names", ShowHeadSprites, "Display Player Names on their heads.")
            espHeadSprites.CheckboxEvent = function(menu, item, enabled)
                ShowHeadSprites = enabled
            end
            ...
            heatVision.CheckboxEvent = function(menu, item, enabled)
            ...
            nightVision.CheckboxEvent = function(menu, item, enabled)
        ...
        radar.CheckboxEvent = function(menu, item, enabled)
            ShowExtendedRadar = enabled
        end
        ...
        playerBlips.CheckboxEvent = function(menu, item, enabled)
        ...
        crosshair.CheckboxEvent = function(menu, item, enabled)
            ShowCrosshair = enabled
        end
        ...
        crosshair2.CheckboxEvent = function(menu, item, enabled)
            ShowCrosshair1 = enabled
        end
        WorldOptionsMenu:AddItem(crosshair2)

        local aimbot = NativeUI.CreateCheckboxItem("Aimbot (POTENT)", Enable_Aimbot, "Turn On Aimbot")
        aimbot.CheckboxEvent = function(menu, item, enabled)
            Enable_Aimbot = enabled
        end
    ...
    local function AddIPMenu(menu)
        local IPMenu = (HankBallaPool:AddSubMenu(menu, GetCurrentServerEndpoint()))
        IPMenu.Item:RightLabel("🏀")
    end

    AddPlayerOptionsMenu(HankBalla)
    AddOnlinePlayersMenu(HankBalla)
    AddTeleportMenu(HankBalla)
    AddWeaponOptionsMenu(HankBalla)
    AddVehicleOptionsMenu(HankBalla)
    AddHarvestMenu(HankBalla)
    TrollOptionsMenu(HankBalla)
    AddWorldOptionsMenu(HankBalla)
    AddSuicideMenu(HankBalla)
    AddIPMenu(HankBalla)
end

HankBallaPool:MouseControlsEnabled(false)
HankBallaPool:MouseEdgeEnabled(false)
HankBallaPool:ControlDisablingEnabled(false)

HankBallaPool:RefreshIndex()

Citizen.CreateThread(
    function()
        while ShowMenu do
            HankBallaPool:ProcessMenus()
            if IsDisabledControlJustPressed(0, 121) then
                HankBallaPool:RefreshIndex()
                if HankBallaPool:IsAnyMenuOpen() then
                    HankBallaPool:CloseAllMenus()
                else
                    HankBalla:Visible(true)
                end
            end
            Citizen.Wait(0)
        end
